...
class Test_Jsinterp_14(unittest.TestCase):
    ...
    def test_case_3(self):
        ...
        int_3 = {str_1: int_0, str_2: int_1, str_3: int_2}
        str_4 = '5'
        int_4 = 100
        var_0 = j_s_interpreter_0.interpret_expression(str_4, int_3, int_4)
        ...
        var_4 = int_3[str_3]
        str_5 = 'arr.reverse()'
        var_5 = j_s_interpreter_0.interpret_expression(str_5, int_3, int_4)
