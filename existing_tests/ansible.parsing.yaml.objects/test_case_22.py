...
class Test_Objects_23(unittest.TestCase):
    ...
    def test_case_22(self):
        ...
        str_3 = '^c_fgAR7'
        int_1 = 912
        var_5 = ansible_vault_encrypted_unicode_2.__ne__(int_1)
        var_6 = ansible_vault_encrypted_unicode_2.__contains__(str_3)
        str_4 = 'n8H8}'
        ansible_unicode_0 = module_0.AnsibleUnicode()
        var_7 = ansible_vault_encrypted_unicode_2.__hash__()
        var_8 = ansible_vault_encrypted_unicode_0.__eq__(ansible_unicode_0)
        dict_1 = {str_3: var_8, str_1: bytes_0, str_1: str_1, str_2: str_2, str_4: str_1}
        ...
        var_9 = ansible_vault_encrypted_unicode_4.isascii()
        ansible_mapping_1 = module_0.AnsibleMapping(**dict_1)
        var_10 = ansible_vault_encrypted_unicode_1.find(ansible_vault_encrypted_unicode_0)
