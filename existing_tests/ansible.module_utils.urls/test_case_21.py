...
class Test_Urls_22(unittest.TestCase):
    ...
    def test_case_21(self):
        try:
            ...
            var_1 = module_0.open_url(bytes_0, unix_h_t_t_p_connection_0, proxy_error_0, h_t_t_p_s_client_auth_handler_0, str_0, bytes_1, proxy_error_0, float_0)
