...
class Test_Json_1(unittest.TestCase):
    ...
    def test_case_0(self):
        ...
        str_9 = 'text/plain'
        str_10 = j_s_o_n_formatter_0.format_body(str_7, str_8)
        str_11 = j_s_o_n_formatter_0.format_body(str_5, str_8)
        str_12 = j_s_o_n_formatter_0.format_body(str_4, str_9)
